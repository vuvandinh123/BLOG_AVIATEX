...
import { CreateDepartmentByAdmin } from "../../../../service/department";
const ModalNewDepartment = ({ isOpen, setIsOpen, setRefresh }) => {
  ...
  const handleSubmitAddCategory = async (e) => {
    ...
    try {
      const res = await CreateDepartmentByAdmin({ name });
      if (res.status === 200) {
      ...
      toast.error(`Thêm phòng ban thất bại ${error}`);
    }
  };
  return (
    <div>
          ...
          <ModalContent>
            ...
            <ModalHeader className="mb-6 space-y-3">
              <div className="space-y-1 uppercase">
                <ModalTitle>Thêm mới phòng ban</ModalTitle>
              </div>
            </ModalHeader>
            <div>
